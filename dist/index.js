    ...
    processEnvVariable(envVariableKey) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (existingTargets.length === 0) {
                core_1.info(`No existing variable found for ${envVariableKey}, creating.`);
                core_1.info(`Gitbranch: ${gitBranch}`);
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const projectName = core_1.getInput("projectName", { required: true });
            const envVariableKeys = core_1.getInput("envVariableKeys", {
                required: true,
            });
            ...
            core_1.info("Vercel env variables completed successfully");
        }
        catch (error) {
